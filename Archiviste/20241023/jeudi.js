...
function generatePipelineJSON(phase) {
  const pipeline = [
    ...
    {
      titre: "Développement du titre",
      sousSections: [
        { sousTitre: "Étape 1", contenu: "Création de titres potentiels" },
        { sousTitre: "Étape 2", contenu: "Analyse des titres proposés" },
        { sousTitre: "Étape 3", contenu: "Validation du titre choisi" }
      ]
    },
    {
      titre: "IA au service de la formation, professionnalisation et valorisation du travail",
      sousSections: [
        { sousTitre: "Étape 1", contenu: "Présentation de l'IA dans le contexte du travail" },
        { sousTitre: "Étape 2", contenu: "Utilisation de l'IA pour améliorer la formation" },
        { sousTitre: "Étape 3", contenu: "Application de l'IA à la professionnalisation" },
        { sousTitre: "Étape 4", contenu: "Valorisation du travail grâce à l'IA" },
        { sousTitre: "Étape 5", contenu: "Exemple de l'IA avec le CVUn.json" }
      ]
    }
  ];
...
const phase = "Lever l'Intelligence Artificielle pour valoriser les talents dans la société numérique";
const pipelineJSON = generatePipelineJSON(phase);
