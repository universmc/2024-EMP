...
async function main() {
  const completion = await groq.chat.completions.create({
    ...
    const outputFilePath = "role_Magistrat" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
