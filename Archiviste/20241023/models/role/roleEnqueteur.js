...
async function main() {
  const completion = await groq.chat.completions.create({
    ...
    const outputFilePath = "role-Enqueteur" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
